...
@XmlRootElement(name = "PostAccommodationUnitResponse", namespace = "http://www.ftn.uns.ac.rs/MegaTravel/soap_accommodation_unit")
public class PostAccommodationUnitResponse {
