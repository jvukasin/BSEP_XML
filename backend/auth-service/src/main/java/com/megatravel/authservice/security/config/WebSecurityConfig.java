package com.megatravel.authservice.security.config;

import com.megatravel.authservice.security.CustomUserDetailsService;
import com.megatravel.authservice.security.TokenUtils;
import com.megatravel.authservice.security.auth.RestAuthenticationEntryPoint;
import com.megatravel.authservice.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
		...
		public void configure(WebSecurity web) throws Exception {
			...
			//coa
			web.ignoring().antMatchers(HttpMethod.POST, "/agents/**");
